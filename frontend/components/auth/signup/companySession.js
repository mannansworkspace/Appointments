                            ...
                            <div className="flex justify-between">
                                <div className="sm:w-3/6 px-2 mb-4">
                                    ...
                                    <span style={{background: '#eee', height: '36px', width: '40px', lineHeight: '38px', top: '1px', left: '1px', borderRadius: '6px 0px 0px 6px', position: 'absolute'}}>+1</span>
                                        <input type="text" maxLength="10" minLength="10" onChange={this.props.onChangeHandler} name="number" value={this.props.value.number}  style={{paddingLeft: '45px'}} className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="" />
                                    </div>
                                </div>
                            </div>
